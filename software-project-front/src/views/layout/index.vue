  ...
  <div>
    <el-container style="height: 100%; border: 1px solid #eee">
      <el-aside width="200px">
        ...
        >
          <el-menu-item index="1" v-if="currUser.unickname == 'admin'">
            <router-link tag="div" to="/goods">雨伞管理</router-link>
          </el-menu-item>
          <el-menu-item index="2" v-if="currUser.unickname != 'admin'">
            <router-link tag="div" to="/order">订单管理</router-link>
          </el-menu-item>
          <el-menu-item index="3" v-if="currUser.unickname == 'admin'">
...
<!--          </el-menu-item>-->
<!--          <el-menu-item index="4" v-show="currUser.unickname == 'admin'">-->
