...
import com.fishman.annotation.AuthCheck;
import com.fishman.common.BaseResponse;
import com.fishman.common.DeleteRequest;
import com.fishman.common.ErrorCode;
import com.fishman.common.ResultUtils;
import com.fishman.constant.UserConstant;
import com.fishman.exception.BusinessException;
import com.fishman.exception.ThrowUtils;

import com.fishman.model.dto.user.*;
import com.fishman.model.entity.Users;
import com.fishman.model.vo.LoginUserVO;
import com.fishman.model.vo.UserVO;
import com.fishman.service.UsersService;
...
public class UsersController {
    ...
    public BaseResponse<LoginUserVO> getLoginUser(HttpServletRequest request) {
        ...
        return ResultUtils.success(usersService.getLoginUserVO(users));
    }
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        return ResultUtils.success(users.getId());
    }
    ...
    public BaseResponse<UserVO> getUserVOById(long id, HttpServletRequest request) {
        BaseResponse<Users> response = getUserById(id, request);
        Users users = response.getData();
        return ResultUtils.success(usersService.getUserVO(users));
    }
    ...
    public BaseResponse<Page<UserVO>> listUserVOByPage(@RequestBody UserQueryRequest userQueryRequest,
        ...
        List<UserVO> userVO = usersService.getUserVO(userPage.getRecords());
    ...
    public BaseResponse<Boolean> updateMyUser(@RequestBody UserUpdateMyRequest userUpdateMyRequest,
        ...
        Users users = new Users();
        BeanUtils.copyProperties(userUpdateMyRequest, users);
