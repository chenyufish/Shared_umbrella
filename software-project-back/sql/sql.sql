...
CREATE TABLE `comment`  (
                            ...
                            `pContent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '评论内容',
...
CREATE TABLE `currentuser`  (
                                ...
                                `token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '唯一的身份标识'
...
CREATE TABLE `goods`  (
                          ...
                          `gName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品名称',
                          `gCount` int(0) NOT NULL COMMENT '商品库存数量',
                          `gContent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品描述',
                          `gPrice` double(10, 2) NOT NULL COMMENT '商品价格',
                          `uId` int(0) NOT NULL COMMENT '售卖商品的用户ID',
                          `gImage` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品图片URL地址',
...
CREATE TABLE `user`  (
                         ...
                         `uPhone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户联系方式',
                         `uNickname` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户昵称',
                         `uEmail` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户邮箱',
                         `uPassword` varchar(78) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户密码',
                         `uIsVerify` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否进行了实名验证',
                         `uAddress` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户校园的地址',
